        ...
        while True:
            ...
            try:
                ...
                if residual_data is not None and if_best:
                    ...
                    # 创建目录存放残差分析结果
                    residual_analyze_dir = "./residual_analyze"
...
# 3. You need to make your answer as concise as possible
    ...
    Returns:
        ...
        try:
            ...
            import os
            import random
            residual_file = os.path.join("./residual_analyze", "residual_analyze.json")
...
##################################################### 
    ...
    def _do_request(self, content: str) -> str:
        ...
        # if True:
            ...
            experience_file = os.path.join("./equation_experiences", "experiences.json")

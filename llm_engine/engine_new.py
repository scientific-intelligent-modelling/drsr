...
parser.add_argument('--quantization', default=True, action='store_true')
parser.add_argument('--model_path', type=str, default='/data/home/zdhs0037/zdhs0037_src_data/meta-llama/Llama-3.1-8B-Instruct/LLM-Research/Meta-Llama-3.1-8B-Instruct')
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    device_map={'':f'cuda:{args.gpu_ids[0]}'}, 
    )
